                                    ...
                                    @if ($student->id == $grade->student_id && $grade->course_id == $course_id)
                                        @foreach (json_decode($grade['grades']) as $student_grades)
                                            <td class="border"><input type="number"
                                                    value="{{ json_decode($student_grades) }}" style="width: 90px;"
                                                    class="form-control p-0 ps-2 m-auto"
                                        ...
                                        @endforeach
                                        <td class="border"><input type="text" disabled
                                                class="w-50 p-0 m-0 text-center border-info"
