...
<div class="card-body table-responsive p-4">
    <div class="row">
        ...
        <x-BaseComponents.form.common.input type="text" name="year" :model="$model" label="السنة الدراسية" />

        <x-BaseComponents.form.common.select_fixed name="is_current_semester" :model="$model" label="اختر الفصل الدراسي الجاري"
        :options="[
            '' => 'غير موجود',
            '1' => 'الفصل الأول',
            '2' => 'الفصل الثاني'
