...
<div class="card-body table-responsive p-4">
    <div class="row">
        ...
        <x-BaseComponents.form.common.password type="password" name="password" :model="$model" label="كلمة المرور" placeholder="أدخل كلمة المرور" />

        <x-BaseComponents.form.common.password type="password" name="password_confirmation" :model="$model" label="تأكيد كلمة المرور" placeholder="تأكيد كلمة المرور" />
